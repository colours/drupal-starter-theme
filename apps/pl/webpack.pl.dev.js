 ...
 * This is merged over top of webpack.starter_theme.dev.js and uses
...
// Custom Imports
const starterTheme = require('../../webpack.starter_theme.dev');
...
const dev = {
    devServer: {
        ...
        openPage: 'pl', // Open browser to the PL landing page so it's very
                        // clear where to go
        hot: true, // Inject css/js into page without full refresh
        historyApiFallback: true, // Finds default index.html files at folder
                                  // root
        inline: true, // Injects all the webpack dev server code right in the
                      // page
        stats: {
            colors: true,
            hash: true,
...
module.exports = merge(starterTheme, pl, dev);
