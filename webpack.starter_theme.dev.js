...
module.exports = {
    ...
    module: {
        rules: [
            ...
            {
                test: /\.js$/,
                // Do NOT babel transpile anything inside node_modules except
                // BOOTSTRAP because we use Bootstrap src modules that require
                // transpiling. If you're not using Bootstrap, set this line
            ...
            {
                exclude: '/(starter_theme.info.yml)/',
                test: /\.(twig|yml|md)$/,
                loader: 'file-loader',
                options: {
                    emitFile: false,
    ...
    plugins: [
        // Provides "global" vars mapped to an actual dependency. Allows e.g.
        // jQuery plugins to assume that `window.jquery` is available
